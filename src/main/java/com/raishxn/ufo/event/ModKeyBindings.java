...
public class ModKeyBindings {
    ...
    public static final KeyMapping OPEN_UFO_TUTORIAL = new KeyMapping(KEY_OPEN_UFO_TUTORIAL, KeyConflictContext.UNIVERSAL,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_W, KEY_CATEGORY_UFO);
}
